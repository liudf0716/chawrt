...
define Device/sunnywifi_s300v20
  DEVICE_VENDOR := SunnyWiFi
  DEVICE_MODEL := S300V20
  DEVICE_DTS := mt7981b-sunnywifi-s300v20
  DEVICE_DTS_DIR := ../dts
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware
  UBINIZE_OPTS := -E 5
  ...
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  IMAGES += factory.bin
  IMAGE/factory.bin := $$(IMAGE/sysupgrade.bin) | cetron-header rd30 S300V20
endef
TARGET_DEVICES += sunnywifi_s300v20
...
define Device/hlktech_hlk-rm65
  DEVICE_VENDOR := Hlktech
  DEVICE_MODEL := HLK-RM65
  DEVICE_DTS := mt7981b-hlk-rm65
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7981-firmware mt7981-wo-firmware kmod-usb3
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7981-bl2 spim-nand-ddr3
  ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot hlktech_hlk-rm65
  SUPPORTED_DEVICES += mediatek,mt7981-spim-snand-rfb
endef
...
define Device/dhlab_in500r
  DEVICE_VENDOR := DHLAB
  DEVICE_MODEL := IN500R
  DEVICE_DTS := mt7891b-dhlab-in500r
  DEVICE_DTS_DIR := ../dts
  DEVICE_PACKAGES := kmod-mt7981-firmware kmod-usb3
  KERNEL_IN_UBI := 1
  UBINIZE_OPTS := -E 5

...
VERSION_DIST:=$(if $(VERSION_DIST),$(VERSION_DIST),$(if $(CONFIG_PACKAGE_default-settings),chawrt,OpenWrt))
VERSION_DIST_SANITIZED:=$(call sanitize,$(VERSION_DIST))

VERSION_MANUFACTURER:=$(call qstrip,$(CONFIG_VERSION_MANUFACTURER))
VERSION_MANUFACTURER:=$(if $(VERSION_MANUFACTURER),$(VERSION_MANUFACTURER),$(if $(CONFIG_PACKAGE_default-settings),chawrt,OpenWrt))
